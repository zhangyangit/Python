...
if __name__ == "__main__":
    ...
    parse = argparse.ArgumentParser(description='Detect nudity in image.')
    parse.add_argument('files', metavar='image', nargs='+', help='Images you wish to test')
    parse.add_argument('-r', '--resize', action='store_true', help='Reduce image size to increase speed of scanning')
    parse.add_argument('-v', '--visualization', action='store_true', help='Generating areas of skin image')
